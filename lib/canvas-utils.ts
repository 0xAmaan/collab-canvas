 ...
 */
export function getViewportTransform(canvas: FabricCanvas): TMat2D {
 ...
 */
export function getZoom(canvas: FabricCanvas): number {
 ...
 */
export function setZoom(canvas: FabricCanvas, zoom: number): void {
  canvas.setZoom(zoom);
  canvas.requestRenderAll();
}
